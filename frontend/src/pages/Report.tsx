    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "#faf9f7", pb: 6 }}>
      ...
      {isFallback && (
        <Box sx={{ maxWidth: 960, mx: "auto", px: { xs: 2, md: 3 }, mt: 2 }}>
          <Alert severity="warning" sx={{ borderRadius: "12px" }}>
            当前展示的是静态演示数据。你可以浏览报告结构、示例建议和评论样式；连接真实后端后会显示实测结果。
          </Alert>
        </Box>
      )}
      ...
      <Box sx={{ maxWidth: 960, mx: "auto", px: { xs: 2, md: 3 }, mt: 2.5 }}>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "2fr 3fr" }, gap: sectionGap, mb: sectionGap }}>
            <Box sx={card}>
              <Typography sx={{ fontWeight: 600, fontSize: 15, color: "#262626", mb: 2 }}>基线对比（示意）</Typography>
            ...
            <Box sx={card}>
              <Typography sx={{ fontWeight: 600, fontSize: 15, color: "#262626", mb: 2 }}>优化建议（示例）</Typography>
          ...
          {(report.optimized_title || report.optimized_content || report.cover_direction) && (
            <Box sx={{ ...card, mb: sectionGap }}>
              <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
                <Typography sx={{ fontWeight: 600, fontSize: 15, color: "#262626" }}>演示优化方案</Typography>
            ...
            <Box sx={{ ...card, mb: sectionGap }}>
              ...
              {optimizing && (
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 1.5, py: 3 }}>
                  ...
                  <Typography sx={{ fontSize: 13, color: "#666" }}>正在生成演示优化方案...</Typography>
                </Box>
              )}
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "3fr 2fr" }, gap: sectionGap, mb: sectionGap }}>
            ...
            <Box sx={card}>
              <Typography sx={{ fontWeight: 600, fontSize: 15, color: "#262626", mb: 2 }}>示意评论区</Typography>
              <SimulatedComments
